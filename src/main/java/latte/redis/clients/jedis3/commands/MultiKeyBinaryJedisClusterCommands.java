...
public interface MultiKeyBinaryJedisClusterCommands {
   ...
   * {@link MultiKeyBinaryJedisClusterCommands#xread(XReadParams, java.util.Map.Entry...)}.
   */
  @Deprecated
  ...
  /**
   * @deprecated This method will be removed due to bug regarding {@code block} param. Use
   * {@link MultiKeyBinaryJedisClusterCommands#xreadGroup(byte..., byte..., XReadGroupParams, java.util.Map.Entry...)}.
   */
  @Deprecated
