...
import latte.redis.clients.jedis3.Protocol.ClusterKeyword;
...
import latte.redis.clients.jedis3.commands.Commands;
...
public class Client extends BinaryClient implements Commands {
  ...
  public void zrangeByScoreWithScores(final String key, final double min, final double max,
    ...
    zrangeByScoreWithScores(SafeEncoder.encode(key), Protocol.toByteArray(min), Protocol.toByteArray(max), offset,
      count);
  }
  ...
  public void zrevrangeByScoreWithScores(final String key, final double max, final double min,
      final int offset, final int count) {
    zrevrangeByScoreWithScores(SafeEncoder.encode(key), Protocol.toByteArray(max), Protocol.toByteArray(min), offset,
      count);
  }
  ...
  /**
   * @deprecated Use {@link Client#clusterReset(ClusterResetType)}.
   */
  @Deprecated
