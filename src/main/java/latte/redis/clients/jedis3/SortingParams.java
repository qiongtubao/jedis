...
public class SortingParams {
  ...
  public SortingParams nosort() {
    params.add(Keyword.BY.getRaw());
    params.add(Keyword.NOSORT.getRaw());
    return this;
  }
  ...
  public SortingParams desc() {
    params.add(Keyword.DESC.getRaw());
    return this;
  }
  ...
  public SortingParams limit(final int start, final int count) {
    params.add(Keyword.LIMIT.getRaw());
  ...
  public SortingParams alpha() {
    params.add(Keyword.ALPHA.getRaw());
    return this;
  }
